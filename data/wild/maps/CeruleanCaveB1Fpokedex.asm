CeruleanCaveB1FWildMonsPokedex:
...
; .EndGrassWildmons
; 	end_grass_wildmonspokedex                    ; Ends the grass encounter data block

; 	def_water_wildmonspokedex 0 ; encounter rate ; Starts the encounter data for water areas, with a 0% encounter rate (meaning no encounters in water)
; 	end_water_wildmonspokedex                    ; Ends the water encounter data block
