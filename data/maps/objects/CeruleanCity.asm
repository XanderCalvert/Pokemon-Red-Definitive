CeruleanCity_Object:
	...
	object_event 28, 12, SPRITE_GUARD, STAY, DOWN, 6 ; Police office blocking house
	...
	object_event  4, 12, SPRITE_SUPER_NERD, STAY, DOWN, 10 ; Blocking the Cerulean Cave entrance ; HS_CERULEAN_CAVE_GUY
	object_event 27, 12, SPRITE_GUARD, STAY, DOWN, 11 ; Police office blocking house
